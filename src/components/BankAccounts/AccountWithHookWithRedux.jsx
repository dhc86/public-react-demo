...
import useBankReduxActions from './hooks/useBankReduxActions';

const AccountWithHookWithRedux = () => {
    const {
        account,
          ...
          <Card className='w-[320px]'>
            <CardContent className='flex flex-col gap-2 p-4'>
              <h2 className='mb-2 text-xl font-semibold'>
                Bank Account with Hook and Redux
...
export default AccountWithHookWithRedux