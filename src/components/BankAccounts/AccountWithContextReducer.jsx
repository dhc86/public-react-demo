...
import { useBankContextWithReducer } from './context/BankContextWithReducer';

// BankAccount component with useContext and useReducer
const AccountWithContextReducer = () => {
  const {
    account,
      ...
      <Card className='w-[320px]'>
        <CardContent className='flex flex-col gap-2 p-4'>
          <h2 className='mb-2 text-xl font-semibold'>
            Bank Account with useContext and useReducer
...
export default AccountWithContextReducer;
